...
type Service interface {
	...
	Login(req *dto.LoginRequest) (string, *dto.LoginResponse, error)
...
func (s *service) Login(req *dto.LoginRequest) (string, *dto.LoginResponse, error) {
